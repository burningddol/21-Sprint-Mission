...
export default function AddItemPage() {
  ...
  const isActive = itemName && itemContent && itemPrice && tags.length;
  ...
  return(
    <StyledForm>
      ...
      <ContentsInput tags={tags} setTags={setTags} setItemName={setItemName} setItemContent={setItemContent} setItemPrice={setItemPrice}/>
    </StyledForm>
  );
}